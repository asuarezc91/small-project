...
*/
import{glsl as o}from"../../../core/shaderModules/interfaces.js";import{DoublePrecision as e}from"../../../core/shaderLibrary/util/DoublePrecision.glsl.js";function r(r,t){const n=r.vertex;n.uniforms.add("uDistanceFalloffFactor","float"),n.code.add(o`
    float distanceBasedPerspectiveFactor(float distance) {
      return clamp(sqrt(uDistanceFalloffFactor / distance), 0.0, 1.0);
    }
  `),n.uniforms.add("uComponentDataTex","sampler2D"),n.uniforms.add("uComponentDataTexInvDim","vec2"),r.attributes.add("componentIndex","float"),n.defines.addFloat("COMPONENT_COLOR_FIELD_OFFSET",0),n.defines.addFloat("COMPONENT_OTHER_FIELDS_OFFSET",1),n.defines.addFloat("COMPONENT_FIELD_COUNT",2),n.defines.addFloat("LINE_WIDTH_FRACTION_FACTOR",8),n.defines.addFloat("EXTENSION_LENGTH_OFFSET",128),n.defines.addFloat("COMPONENT_TEX_WIDTH",4096),n.code.add(o`
  ...
  `),t.legacy?n.code.add(o`
    ...
    `):(n.uniforms.add("uTransformNormal_GlobalFromModel ","mat3"),n.code.add(o`
      vec3 _modelToWorldNormal(vec3 normal) {
        return uTransformNormal_GlobalFromModel * normal;
      }
    `)),t.silhouette?(r.attributes.add("normalA","vec3"),r.attributes.add("normalB","vec3"),n.code.add(o`
      vec3 worldNormal() {
        return _modelToWorldNormal(normalize(normalA + normalB));
      }
    `)):(r.attributes.add("normal","vec3"),n.code.add(o`
      vec3 worldNormal() {
    ...
    `):(r.vertex.include(e,t),n.code.add(o`
      vec3 worldFromModelPosition(vec3 position) {
  ...
  `)}!function(o){o.usesSketchLogic=function(o){return 1===o.mode||2===o.mode},o.usesSolidLogic=function(o){return 0===o.mode||2===o.mode}}(r||(r={}));export{r as EdgeUtil};
