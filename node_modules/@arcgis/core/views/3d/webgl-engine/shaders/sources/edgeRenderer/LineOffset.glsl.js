...
import{glsl as e}from"../../../core/shaderModules/interfaces.js";import{RgbaFloatEncoding as t}from"../../../core/shaderLibrary/util/RgbaFloatEncoding.glsl.js";import{EdgeUtil as a}from"./EdgeUtil.glsl.js";import{UnpackAttributes as r}from"./UnpackAttributes.glsl.js";function u(u,s){const c=u.vertex;u.include(r,s);const l=u.fragment;switch(a.usesSketchLogic(s)&&(c.uniforms.add("uStrokesTextureScale","vec2"),c.uniforms.add("uStrokesLog2Resolution","float"),c.uniforms.add("uStrokeVariants","float"),u.varyings.add("vStrokeUV","vec2"),l.uniforms.add("uStrokesTexture","sampler2D"),l.uniforms.add("uStrokesNormalizationScale","float"),c.code.add(e`
    ...
    `),u.fragment.include(t),l.code.add(e`
    ...
    `)),s.mode){case 0:c.code.add(e`
      ...
      `);break;case 2:u.varyings.add("vType","float"),c.code.add(e`
        void calculateStyleOutputs(UnpackedAttributes unpackedAttributes)
        {
