...
*/
import{glsl as e}from"../../shaderModules/interfaces.js";import{Water as o}from"../shading/Water.glsl.js";import{EvaluateMainLighting as r}from"../shading/EvaluateMainLighting.glsl.js";function t(t,a){3!==a.pbrMode&&4!==a.pbrMode||t.include(o,a),t.vertex.uniforms.add("overlayTexOffset","vec4"),t.vertex.uniforms.add("overlayTexScale","vec4"),t.varyings.add("vtcOverlay","vec4"),t.vertex.code.add(e`
    void setOverlayVTC(in vec2 uv) {
      vtcOverlay = vec4(uv, uv) * overlayTexScale + overlayTexOffset;
    }
  `),t.fragment.uniforms.add("ovInnerColorTex","sampler2D"),t.fragment.uniforms.add("ovOuterColorTex","sampler2D"),t.fragment.uniforms.add("overlayOpacity","float"),t.fragment.code.add(e`
  ...
  `),3!==a.pbrMode&&4!==a.pbrMode||(t.include(r),t.fragment.code.add(e`
